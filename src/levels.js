...
export const levels = [
    {
        cards: [
            {name: 'cake', id: 1234, url: cake},
            {name: 'cookie', id: 1235, url: cookie},
            {name: 'cake', id: 1236, url: cake},
            {name: 'cookie', id: 1237, url: cookie},
            {name: 'donut', id: 1238, url: donut},
            {name: 'donut', id: 1239, url: donut},
            {name: 'candy', id: 1240, url: candy},
            {name: 'candy', id: 1241, url: candy},
            {name: 'roll', id: 1242, url: roll},
            {name: 'roll', id: 1243, url: roll},
            {name: 'croissant', id: 1244, url: croissant},
    ...
    },
    {
        cards: [
            ...
            {name: 'cracker', id: 1261, url: cracker}
        ],
        difficulty: 'expert'
    }
] 