...
class MainMenuPopup extends React.Component {
    ...
    onHit = e => {
        ...
        this.setState((prevState) => {
            return {
                ...prevState,
                eatenCandy: e.dragData,
                currentDialogue: "satisfied",
                dragEntered: false
            }
        })
                    ...
                    <div className="modal">
                        ...
                        <div className="modal__main-block">
                            <div className="modal__candy-block">
                                <CandyBagIcon slideDoorSound={this.slideDoorSound}
                                    userCandies={userCandies}
                                    toggleCandyBagHidden={this.toggleCandyBagHidden} />
                            </div>
                            <div className="modal__text-block">
                                ...
                                <CandyBag pickCandy={this.pickCandy}
                                    userCandies={userCandies}
                                    candyBagModal={this.state.candyBagModal} />
                            </div>
                        </div>

                        <div className="modal__buttons-block">
                            <button className={`button button_menu button_brown ${simpleLevelWin}`}
                                onClick={() => {
                                    chooseDifficulty('simple');
                                    this.closeCandyBag();
                                    this.setDialogue()
                                }}>
                                {t('levels.simple')}
                            </button>
                            <button className={`button button_menu button_purple ${regularLevelWin}`}
                                onClick={() => {
                                    chooseDifficulty('regular');
                                    this.closeCandyBag();
                                    this.setDialogue()
                                }}>
                                {t('levels.regular')}
                            </button>
                            <button className={`button button_menu button_orange ${expertLevelWin}`}
                                onClick={() => {
